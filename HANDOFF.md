...
- Native `firmware/` reads sensor identities and RTC advancement, logs touch/raw IMU/power telemetry, and attempts a non-formatting SD roundtrip. No microSD is installed. User confirms the screen is stable; corner/center touches and tilt response are recorded.
