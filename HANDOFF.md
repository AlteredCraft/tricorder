...
`headphones-1` is collecting the operator headphone fixture. Unexpected USB reset produced boot `06d6b01b818460f955691d1b531e17c8` despite no reset request; retain the expected-boot failure and assess the actual complete boot separately. Credentials are RAM-only and need re-entry. Inspect live handles before opening USB again.
