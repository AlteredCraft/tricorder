...
extern "C" esp_video_buffer_element* __wrap_esp_video_recv_element(esp_video*,unsigned,unsigned);
unsigned last_timeout=0;
extern "C" esp_video_buffer_element* __real_esp_video_recv_element(esp_video*,unsigned,unsigned timeout) {
 last_timeout=timeout;return reinterpret_cast<esp_video_buffer_element*>(3);
}
...
int main() {
 assert(__wrap_esp_video_recv_element(nullptr,1,0xffffffff)!=nullptr && last_timeout==2000);
 assert(__wrap_esp_video_recv_element(nullptr,1,30)!=nullptr && last_timeout==30);
