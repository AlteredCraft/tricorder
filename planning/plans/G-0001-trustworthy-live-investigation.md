...
| [.04 Agent interaction](G-0001.04-agent-interaction.md) | In progress | A/B path, spoken question and spoken guidance shared with G-0002. Latency/recovery statistics open. |
| [.05 Power and recovery](G-0001.05-power-recovery.md) | Not built | — |

**Status:** In progress. Resumed 2026-09-24 now that G-0002 is Met.
