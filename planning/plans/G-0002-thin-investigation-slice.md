...
| Spec | Status | State |
| --- | --- | --- |
| [.01 Guided A/B vertical slice](G-0002.01-guided-ab-slice.md) | In progress | Mock loop, failure handling, SD archive/replay, live text model, the instrument view (live spectrum, A/B overlay), a context photo and a steadiness indicator work. Next: spoken ask (local speech-to-text chosen), broadband fixture, three rated live loops. |
