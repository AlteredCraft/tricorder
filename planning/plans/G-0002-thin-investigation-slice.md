...
**Status.** In progress. Three corrected developmental mock loops and controlled delay/cancel/disconnect trials have scoped evidence. SD-backed Wi-Fi setup, verified capture archives/downloads and explicitly labeled replay are implemented. Both new SD-backed physical attempts remain incomplete; three replays complete without new acquisition. The latest physical B upload failure remains unresolved. Live work is deferred.
