...
| Goal | Status | Summary |
| --- | --- | --- |
| [G-0002 One usable end-to-end investigation](plans/G-0002-thin-investigation-slice.md) | In progress | **Priority.** Guided A/B works end to end with the mock service and a live text model. The UI is still text only. Speech and live usefulness ratings are open. |
