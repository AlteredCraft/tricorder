...
| Goal | Status | Summary |
| --- | --- | --- |
| [G-0002 One usable end-to-end investigation](plans/G-0002-thin-investigation-slice.md) | In progress | **Priority.** Guided A/B works end to end with the mock service and a live text model, and the screen shows a live spectrum, an A/B overlay, a context photo, a steadiness indicator and a spoken question transcribed on the Mac. Live usefulness ratings are open. |
