...
These need your participation or equipment. Progress and evidence stay in [planning/milestones.md](planning/milestones.md); this list is only the handoff to you.
...
- **Audio fixture:** help with repeatable stationary sound/speech tests, including device playback, after the combined workload is ready. The six microphone-position takes are complete; no need to repeat them now.
...
The 60-second native camera baseline, two isolated audio baselines and repeated live raw/speech integrity captures have passed. Full G-0001 acceptance is still in progress.
