...
- **Re-rate usefulness:** after results become conclusive (G-0002.01 Open 2), repeat rated loops on real sound questions.
...
- **Wi-Fi change:** reprovision from a local `.env.local.*` file. Keep the SD card private because it holds credentials. As of 2026-09-24 the Tab5 is provisioned for Newnet (`.env.local.newnet`, endpoint 192.168.0.44).
